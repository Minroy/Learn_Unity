...
namespace MaxyGames.UNode.Editors {
	public class GlobalSearch : EditorWindow {
		private GraphEditorUtility.ReferenceTree referenceTree;
		...
		private void OnEnable() {
			...
			referenceTree = new GraphEditorUtility.ReferenceTree(new List<object>());
		}
		...
		void SearchChanged() {
			...
			var references = GraphEditorUtility.SearchReferences(element => {
				try {
